...
function Nav () {
  return (
    <header className='h-16 sticky top-0 md:w-full md:h-24 bg-White md:z-50'>
      <nav className='px-6 h-full md:px-64 flex items-center justify-between'>
        ...
        <ol className='hidden md:flex md:gap-8 md:items-center md: h-full'>
          <li>
