...
function HamburgerMenu () {
  ...
  return (
    <div className='md:hidden'>
      ...
      {modalOpen && (
        <div className='mt-16 fixed inset-0 px-6'>
          <div className='flex flex-col items-center justify-between mt-4 h-56 w-full text-DarkBlue bg-White p-6 rounded drop-shadow-[0_55px_95px_#001623]'>
            <a href='#'>Home</a>
            <a href='#'>About</a>
            <a href='#'>Contact</a>
            <a href='#'>Blog</a>
